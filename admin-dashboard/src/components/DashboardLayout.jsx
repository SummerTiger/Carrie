...
function DashboardLayout() {
  ...
  const menuItems = [
    ...
    { path: '/dashboard/vendors', label: 'Vendors', icon: '🏢' },
    { path: '/dashboard/categories', label: 'Product Categories', icon: '🗂️' },
    { path: '/dashboard/product-brands', label: 'Product Brands', icon: '🏷️' },
    { path: '/dashboard/machine-brands', label: 'Machine Brands', icon: '🔧' },
    { path: '/dashboard/machine-models', label: 'Machine Models', icon: '⚙️' },
